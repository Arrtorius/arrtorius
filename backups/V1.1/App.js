  ...
  return (
    ...
    <Card.Title> 
      ...
      <Card.Text>
       ...
       <small className="font-weight-light">
       <p className="text-start fs-5">
       <i>"Mercer!"</i> came a deep growly voice from behind him. he turned around to find them standing there: Rogonaar, Morteious, Meyena and Kenny. as well as the two fresh faces he saw back in Stormwind: Katherine, Rogonaar's sister, and Drartur, cousin of Kazarak.
       </p>
       </small>
       </Card.Text>
    ...
    <Card.Body>
      ...
      <p className="fs-4">
       ...
       <small className="font-weight-light">
       <p className="text-start fs-5">
       A moment of silence passed by as the members of the order descended towards the port. <i>"Much has happened when I was there. so many... deaths. Truth be told, I wasn't sure if I could bear to face this cursed place alone. so, I appreciate the support, this means a lot."</i> said Mercer, breaking the silence.
       </p>
       </small>
       </Card.Text>
       ...
       <i>"Must be one hell of a dangerous job if you're thanking us beforehand."</i> said huntress Meyena as she raised an eyebrow. <i>"It is. would've done it by myself otherwise."</i> he replied quickly.
        <i>"We're with ya lad; we'll get tae the bottom o' this."</i> said the wildhammer dwarf Drartur in an assuring tone. <i>"I... appreciate that, master dwarf."</i> he replied. 
       </p>
       </small>
       </Card.Text>
       ...
       <small className="font-weight-light">
       <p className="text-start fs-5">
       Finally, after a few minutes of walking they reached the ships. <i>"All aboard the flagship. we're setting sail ahead of the other two. they'll be following us."</i> Mercer uttered to the wolves as he turned facing them, waiting for them to board the ship before himself.
       </p>
       </small>
       </Card.Text>
